...
echo "2. Start backend server: make start-backend"
echo "3. Start frontend server: make start-frontend (in another terminal)"
echo "4. Access application: http://127.0.0.1:3000"
echo ""
